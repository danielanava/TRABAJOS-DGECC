...
<body background="\elconsejo\images\Fondo1.jpg">
	<P align="right"><a href="/elconsejo/sesion.html"><input  class="btn btn-danger" name="submit" value="Iniciar Sesion"/></a></P>
	<center><div class="tit"><h2 style="color: #0000FF; ">Registro de Usuario</h2>
	...
	<!-- <table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 14pt; color: #FFFFFF;"><b>Correo: </b></label></td>
			<td width=80> <input class="form-group has-success" style="border-radius:15px;" type="mail" name="mail"></td></tr>
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      <label style="font-size: 18pt; color: #FFFFFF;"><b>Ingresa tu nombre</b></label>
